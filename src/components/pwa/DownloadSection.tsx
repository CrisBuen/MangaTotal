...
export function DownloadSection() {
  ...
  return (
    <section
      className="rounded-[10px] border border-line bg-panel p-6 sm:p-8"
    ...
    >
      <div className="mb-8 text-center">
        ...
        <h2 className="mt-3 font-display text-[clamp(2rem,5vw,3rem)] font-bold leading-tight tracking-[-0.04em] text-ink">
          Instalá la app
        </h2>
      ...
      <div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a
          ...
          download
          className="group flex flex-col items-center gap-3 rounded-[10px] border border-line bg-[var(--surface-raised)] p-7 text-center transition-colors hover:border-line-strong"
          data-od-id="download-windows"
        >
          <svg viewBox="0 0 24 24" className="h-9 w-9 fill-current text-accent-ink" aria-hidden="true">
            <path d="M3 5.5 10 4.5v7H3v-6zM11 4.3 21 3v8.5H11v-7.2zM3 12.5h7v7L3 18.5v-6zM11 12.5h10V21l-10-1.3v-7.2z" />
          </svg>
          <div>
            <p className="font-display text-xl font-bold text-ink group-hover:text-accent-ink">
              Windows
            </p>
          ...
          <span className="mt-1 rounded-md border border-accent bg-[var(--accent-soft)] px-4 py-2 font-mono text-[11px] font-bold tracking-[0.06em] text-accent-ink">
            Descargar
          </span>
        </a>

        {/* Android / instalación desde el navegador */}
        <div className="flex flex-col items-center gap-3 rounded-[10px] border border-line bg-[var(--surface-raised)] p-7 text-center">
          <svg viewBox="0 0 24 24" className="h-9 w-9 fill-current text-accent-ink" aria-hidden="true">
          ...
          <a
            href={ANDROID_APK}
            download
            className="mt-1 rounded-md border border-accent bg-[var(--accent-soft)] px-4 py-2 font-mono text-[11px] font-bold tracking-[0.06em] text-accent-ink transition hover:opacity-90"
          ...
          {installed ? (
            ...
            <button
              onClick={installApp}
              className="font-mono text-[11px] tracking-[0.06em] text-subtle underline underline-offset-4 transition hover:text-accent-ink"
        ...
        {GOOGLE_PLAY_URL ? (
          ...
          <div
            className="flex flex-col items-center gap-3 rounded-[10px] border border-line bg-[var(--surface-raised)] p-7 text-center opacity-75"
          ...
          >
            ...
            <span className="mt-1 rounded-md border border-line px-4 py-2 font-mono text-[11px] font-bold tracking-[0.06em] text-subtle">
              Próximamente
            </span>
          </div>
        )}
      ...
      <p className="mt-7 text-center font-mono text-[11px] tracking-[0.06em] text-subtle">
