...
export const config = {
  ...
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|icon.svg|robots.txt|sitemap.xml|sw.js|manifest.webmanifest|offline|icons/|descargas/|api/admin/upload|api/auth/avatar).*)",
  ],
};
